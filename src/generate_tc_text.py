"""
텍스트 파일(.txt) 기반 TC 자동 생성
사용법: python src/generate_tc_text.py docs/기획서.txt
"""
import sys
import io
...
parser.add_argument("file", help="기획서 텍스트 파일 경로")
...
print(f"파일: {file_path} ({len(content)}자)\n")

# 텍스트가 너무 길면 앞 4000자만 사용
