"""
Word 기획서(.docx) 기반 TC 자동 생성
사용법: python src/generate_tc_word.py docs/기획서.docx
...
try:
    ...
    print("[ERROR] python-docx가 설치되지 않았습니다: pip install python-docx")
    sys.exit(1)
...
parser.add_argument("file", help="기획서 Word 파일 경로 (.docx)")
...
print(f"단락 {len(paragraphs)}개, 표 데이터 {len(table_texts)}행 추출")
